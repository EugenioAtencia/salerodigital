const MENU_DETAIL_HTML = `<!doctype html>
<html lang="es">
<head>
  <title>Menú comercial | Salero Digital</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="Menús comerciales de Salero Digital para negocios locales que quieren empezar con una estrategia digital clara y sin sorpresas.">
  ...
  <link rel="stylesheet" href="/assets/css/nuestros-menus.css?v=7">
</head>
<body class="menu-detail-page">
  ...
  <main data-detail data-type="menu">
    <div class="container section"><div class="loading">Cargando menú desde el CMS...</div></div>
  </main>
  ...
  <script src="/assets/js/detail.js?v=4" defer></script>
</body>
</html>`;

export async function onRequest() {
  return new Response(MENU_DETAIL_HTML, {
    status: 200,
    headers: {
