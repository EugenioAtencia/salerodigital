...
<html lang="es">
<head>
  <title>Sector | Salero Digital</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="Marketing digital para sectores reales de la comarca. Estrategia, web, SEO, redes y campañas con Salero Digital.">
...
<body class="sector-detail-page">
  ...
  <main id="sector-detail-root" data-detail data-type="sector" data-slug="${safeSlug}">
    <div class="container section"><div class="loading">Cargando contenido desde el CMS...</div></div>
  </main>
  ...
  <script src="/assets/js/detail.js?v=7"></script>
